...
export interface ShotPromptTemplate {
  id: string
  label: string
  description: string
...
export const SHOT_PROMPT_TEMPLATES: ShotPromptTemplate[] = [
  {
    id: 'slow_pan_lr',
    label: 'Slow pan L → R',
...
export function getShotTemplate(shotId: string): ShotPromptTemplate | undefined {
  return SHOT_PROMPT_TEMPLATES.find(t => t.id === shotId)
}
