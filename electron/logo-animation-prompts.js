...
exports.LOGO_ANIMATION_TEMPLATES = void 0;
exports.getLogoAnimationTemplate = getLogoAnimationTemplate;
...
exports.LOGO_ANIMATION_TEMPLATES = [
    {
        id: 'fade_scale_in',
        label: 'Fade & Scale In',
...
function getLogoAnimationTemplate(animationId) {
    return exports.LOGO_ANIMATION_TEMPLATES.find(t => t.id === animationId);
}
function buildLogoAnimationPrompt(animationId, logoDescription) {
